...
<script type="text/javascript">
	...
	function pay() {
		window.location.href = "/Cineplex/member/personpay.jsp";
	}
</script>
...
<body>
	...
	<div class="container-fluid col-md-10 col-md-offset-1">
		...
		out.print("<h4> </h4>");
		if(member.getRank() == 0){
			out.print("<button name='operation' value='rank' onclick='pay()'>成为会员</button>");
		}
		if(member.getIsFrozen()) {
			out.print("<button name='operation' value='activate' onclick='pay()'>续费激活</button>");
		}
		%>
